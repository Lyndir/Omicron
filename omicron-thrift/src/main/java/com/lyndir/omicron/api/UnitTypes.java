                  ...
                  public ImmutableList<? extends Module> get() {
                      return ImmutableList.of( BaseModule.createWithStandardResourceCost()
                                               ...
                                               ContainerModule.createWithStandardResourceCost()
                                                              .resourceType( com.lyndir.omicron.api.core.ResourceType.METALS )
                                                              .capacity( 10 ), //
                                               ContainerModule.createWithStandardResourceCost()
                                                              .resourceType( com.lyndir.omicron.api.core.ResourceType.FUEL )
                                                              .capacity( 5 ), //
                                               ContainerModule.createWithStandardResourceCost()
                                                              .resourceType( com.lyndir.omicron.api.core.ResourceType.RARE_ELEMENTS )
                                                              .capacity( 5 ), //
                                               ContainerModule.createWithStandardResourceCost()
                                                              .resourceType( com.lyndir.omicron.api.core.ResourceType.SILICON )
                                                              .capacity( 5 ) );
                  }
              } ),
    QUARRY( "Quarry", 5, //
