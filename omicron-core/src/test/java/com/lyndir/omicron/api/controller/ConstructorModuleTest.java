...
public class ConstructorModuleTest extends AbstractTest {
    ...
    public void testOnNewTurn()
        ...
        UnitType baseUnit = testUnitType( "Base Unit", 5, new BaseModule( 1, 1, 1, ImmutableSet.<LevelType>of() ) );
        UnitType baseMobilityUnit = testUnitType( "Mobility Unit", 5, new BaseModule( 1, 1, 1, ImmutableSet.<LevelType>of() ),
